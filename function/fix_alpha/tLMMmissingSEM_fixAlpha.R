...
tLMM.miss.SEM = function(Data, X, Z, V, g=g, init.para, cor.type = c("UNC", "ARp", "BAND1", "CS"), M = 100, M.LL = 1000, P=1, tol = 1e-6, max.iter=max.iter, per=1, mechanism=c('MNAR','MCAR'))
{
  ...
  IM2 = I.tlmm.missing(para.est, cor.type=cor.type, X=X, N=N, cumsum.ni=cumsum.ni, ni=ni, mc.size=mc.size, TLam.inv=TLam.inv,
  ...
  return(list(model.inf = model.inf, para.est = para.est, iter=iter, y.c=y.hat, IM2=IM2, 
