################################################################################
#                                                                                     
#   Filename    :    LMMmissingSEM_fixAlpha.R  												  
...
LMM.miss.SEM <- function(Data, X, Z, V, g = g, init.para, cor.type = c("UNC", "ARp", "BAND1", "CS"), M = 100, M.LL = 1000, P = 1, tol = 1e-6, max.iter = max.iter, per = 1, mechanism = c("MNAR", "MAR", "MCAR")) {
  ...
  cat("Mixture of Linear mixed models with ", cor.type[1], " errors: ", "\n")
  ...
  cat(rep("=", 20), "Mixture of Linear mixed models with ", cor.type[1], " errors", rep("=", 20), sep = "", "\n")
