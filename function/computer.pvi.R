...
compute.pvi = function(Data, X, Z, V, g=g, init.para, fit, cor.type = c("UNC", "ARp", "BAND1", "CS"), M = 100, M.LL = 1000, P=1, tol = 1e-6, max.iter=max.iter, per=1, mechanism=c('MNAR','MCAR'))
{
  begin = proc.time()[1]
  ...
  # V.i = V.fun.i(y.i = y.hat.i, treat.i = Data.miss[idx1,]$treat)
  # print(V)
  # print(alpha)
