...
### ### ### ### ### ### ### ### ### 
load(paste0(PATH, "/Data/fix_alpha/fix_alpha1.RData"))
alpha[4]
fit.beta = est.beta = NULL
fix_alpha = alpha[4]
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))

load(paste0(PATH, "/Data/fix_alpha/fix_alpha2.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha3.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha4.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha5.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha6.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha7.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha8.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha9.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM2$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha10.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM2$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha13.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha14.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha15.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha16.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha17.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha18.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha19.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha20.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM2$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha21.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))
load(paste0(PATH, "/Data/fix_alpha/fix_alpha22.RData"))
fix_alpha = c(fix_alpha, alpha[4])
est.beta = rbind(est.beta, t(est.MNAR$IM$out[,1:6]))
