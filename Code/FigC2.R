...
#   Date        :    07.08.2025
#   Purpose     :    produce Figure C2 in Appendix C
#
#   Input data files  :  None
#   Output data files :  Data_and_Code/results/FigureC2.pdf
#
#   R Version   :    R-4.3.1                                                              
...
multiplot(plotlist = list(k2), layout = layout)


pdf(paste0(PATH, "/Result/FigureC2.pdf"), width = 12, height = 8)
multiplot(plotlist = list(k2), layout = layout)
dev.off()