...
ppc1.1$GG = c(c(rep(c("MAR t", "MCAR t"), each = 9*5), rep(c("MNAR t"), each = 13*5)))
...
ppc2.1$GG = c(c(rep(c("MAR t", "MCAR t"), each = 9*5), rep(c("MNAR t"), each = 13*5)))
...
ppc3.1$GG = c(c(rep(c("MAR t", "MCAR t"), each = 9*5), rep(c("MNAR t"), each = 13*5)))
