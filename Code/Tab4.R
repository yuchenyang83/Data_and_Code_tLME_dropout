...
#   Date        :    07.08.2025
#   Purpose     :    produce Table 4 for AIDS
#
#   Input data files  :  Data_and_Code/Data/fit_result.RData
#   Output data files :  Data_and_Code/results/Table4.csv
#
#   R Version   :    R-4.3.1                                                              
...
colnames(sum.table) <- c("LME", "tLME", "LME", "tLME", "LME", "tLME", "LME", "tLME")
row.names(sum.table) <- c(rep(c("m", "ell_max", "AIC", "BIC"), time = 3))


write.csv(sum.table, paste0(PATH, "/Result/Table4.csv"))
