...
for (Rep in Rep:Repp) {
  ...
  set.seed(seednum)
  if (n == 25) PATH1 <- paste0(PATH, "/Data/Simulation/SS-simulationSEM-t75/SIM1/")
  if (n == 50) PATH1 <- paste0(PATH, "/Data/Simulation/SS-simulationSEM-t75/SIM2/")
  if (n == 100) PATH1 <- paste0(PATH, "/Data/Simulation/SS-simulationSEM-t75/SIM3/")
  if (n == 200) PATH1 <- paste0(PATH, "/Data/Simulation/SS-simulationSEM-t75/SIM4/")
  if (n == 400) PATH1 <- paste0(PATH, "/Data/Simulation/SS-simulationSEM-t75/SIM5/")
