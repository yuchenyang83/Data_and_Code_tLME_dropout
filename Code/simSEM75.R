...
# SIM1:
n=25; PATH1 = paste0(getwd(), "/Data/Simulation/SS-simulationSEM-t25/SIM1/")
...
for (Rep in 1:100) {
  for(ll in 1:length(N)){
    n = N[ll]
    if(n==25) PATH1 = paste0(getwd(), "/Data/Simulation/SS-simulationSEM-t75/SIM1/")
    if(n==50) PATH1 = paste0(getwd(), "/Data/Simulation/SS-simulationSEM-t75/SIM2/")
    if(n==100) PATH1 = paste0(getwd(), "/Data/Simulation/SS-simulationSEM-t75/SIM3/")
    if(n==200) PATH1 = paste0(getwd(), "/Data/Simulation/SS-simulationSEM-t75/SIM4/")
    if(n==400) PATH1 = paste0(getwd(), "/Data/Simulation/SS-simulationSEM-t75/SIM5/")
