...
source('/Users/yangyucheng/Desktop/Boss/NLME-missing/simulation-t/program8/SS-simulationSEM-t25/funciton.r')
source('/Users/yangyucheng/Desktop/Boss/NLME-missing/simulation-t/program8/SS-simulationSEM-t25/tLMMmissingSEM.r')
source('/Users/yangyucheng/Desktop/Boss/NLME-missing/simulation-t/program8/SS-simulationSEM-t25/LMMmissingSEM.r')

# SIM1:n=25; PATH='/Users/yangyucheng/Desktop/Boss/NLME-missing/simulation-t/program8/SS-simulationSEM-t25/SIM1/'
# SIM2:n=50; PATH='/Users/yangyucheng/Desktop/Boss/NLME-missing/simulation-t/program8/SS-simulationSEM-t25/SIM2/'
# SIM3:n=100; PATH='/Users/yangyucheng/Desktop/Boss/NLME-missing/simulation-t/program8/SS-simulationSEM-t25/SIM3/'
# SIM4:n=200; PATH='/Users/yangyucheng/Desktop/Boss/NLME-missing/simulation-t/program8/SS-simulationSEM-t25/SIM4/'
# SIM5:n=400; PATH='/Users/yangyucheng/Desktop/Boss/NLME-missing/simulation-t/program8/SS-simulationSEM-t25/SIM5/'
...
library(ggplot2)
k1 = ggplot()+
  geom_line(data = Data, aes(x=Time, y=y.c, grop=as.factor(Subject))) + 
  geom_line(data = Data, aes(x=Time, y=Var1, col=as.factor(treat), grop=as.factor(Subject))) + xlab("Time") + ylab(NULL) +
...
for(Rep in 1:200){
  ...
  write(c(Rep, aic), paste(PATH,'aic.txt',sep=""), ncol=10000, append=T)
  write(c(Rep, bic), paste(PATH,'bic.txt',sep=""), ncol=10000, append=T)
  write(c(Rep, MSE.y), paste(PATH,'MSE.txt',sep=""), ncol=10000, append=T)
  write(c(Rep, MAE.y), paste(PATH,'MAE.txt',sep=""), ncol=10000, append=T)
  write(c(Rep, MAPE.y), paste(PATH,'MAPE.txt',sep=""), ncol=10000, append=T)
  write(c(Rep, iter), paste(PATH,'iter.txt',sep=""), ncol=10000, append=T)
  ...
  drop_rate = sum(Data$R)/n
  write(c(Rep, drop_rate), paste(PATH,'drop_rate.txt',sep=""), ncol=10000, append=T)
}
