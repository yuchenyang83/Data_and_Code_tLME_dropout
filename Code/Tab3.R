...
MAE1 =    as.matrix(read.table(paste(PATH1,'MAE.txt',sep=""),na.strings="NA",sep=""))
MAPE1 =    as.matrix(read.table(paste(PATH1,'MAPE.txt',sep=""),na.strings="NA",sep=""))
...
MAE2 =    as.matrix(read.table(paste(PATH2,'MAE.txt',sep=""),na.strings="NA",sep=""))
MAPE2 =    as.matrix(read.table(paste(PATH2,'MAPE.txt',sep=""),na.strings="NA",sep=""))
...
MAE3 =    as.matrix(read.table(paste(PATH3,'MAE.txt',sep=""),na.strings="NA",sep=""))
MAPE3 =    as.matrix(read.table(paste(PATH3,'MAPE.txt',sep=""),na.strings="NA",sep=""))
...
MAE4 =    as.matrix(read.table(paste(PATH4,'MAE.txt',sep=""),na.strings="NA",sep=""))
MAPE4 =    as.matrix(read.table(paste(PATH4,'MAPE.txt',sep=""),na.strings="NA",sep=""))
...
MAE5 =    as.matrix(read.table(paste(PATH5,'MAE.txt',sep=""),na.strings="NA",sep=""))
MAPE5 =    as.matrix(read.table(paste(PATH5,'MAPE.txt',sep=""),na.strings="NA",sep=""))
